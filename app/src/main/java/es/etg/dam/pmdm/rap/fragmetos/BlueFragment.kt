...
import es.etg.dam.pmdm.rap.fragmetos.databinding.FragmentBlueBinding
...
class BlueFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(arguments!=null){
            //Leo el parámetro y muestro el mensaje por pantalla
            Toast.makeText(this.activity, requireArguments().getString(MainActivity.NOMBRE) , Toast.LENGTH_SHORT).show()
        }
        val btn: Button = view.findViewById(R.id.btnSumar)
        btn.setOnClickListener { listener?.onClickFragmentButton() }
    }
